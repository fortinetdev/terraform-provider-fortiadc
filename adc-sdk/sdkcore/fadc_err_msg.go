...
var fadc_err = map[string]string{
	...
	"-517":  "Failed to append child list.",
	...
	"-202":  "IP address is blocklisted. Wait a few minutes before trying again.",
	...
	"-214":  "Invalid token",
	"-216":  "Invalid user",
	"-217":  "You need to disable shell access and modify the username or passowrd during next shell access enable config session.",
	"-218":  "Username is already used by system.",
	...
	"-171":  "Build-in certificate is not allowed to export.",
	...
	"-166":  "Invalid CERT Subject Alternative Name",
	"-172":  "HSM FIPS key size is too small",
	"-76":   "System API error.",
	...
	"-1292": "SSL version max is lower than min",
	"-1293": "The specified interface ip and CoA port are used by other.",
	"-1294": "The interface ip is required for CoA.",
	"-1295": "The same HA Node Number is already exist in current NAT Source Pool.",
	"-1296": "IPV6 pool is not supported on Layer 2 virtual server.",
	"-1297": "Content routing is referenced by Layer 2 virtual server, IPV6 pool is not supported",
	"-1298": "The specified Profile is not supported by L2 IPv6.",
	"-1299": "The port number must be set to 21 when the profile type is FTP.",
	...
	"-1451": "Egress Interface must be set.",
	...
	"-3047": "Zone type is not allowed to switch.",
	...
	"-3095": "NS record is not allow to change domain or remove, should remove the related dsset file and save the zone first.",
	"-3096": "Dsset file is not allow to add, should add the related ns record first.",
	"-3097": "TXT record text contains unmatched double quotes.",
	"-3098": "Port 53 is conflict with GLB Setting Listen on Port ",
	"-3099": "Port 53 is conflict with System Settings Basic",
	...
	"-3219": "Predefine isp is used by global-load-balance link.",
	"-3220": "Predefine isp is used by global-load-balance host.",
	...
	"-5003": "Host is invalid.",
	"-5004": "URL is invalid.",
	"-5005": "Name is invalid.",
	"-5006": "Value is invalid.",
	...
	"-3512": "Bot detection allowlist rule cannot be empty.",
	...
	"-3531": "Secure should be set when using samesite none.",
	"-3532": "Request URL should begin with '/'.",
	"-3533": "URL regular expression is invalid.",
	"-3534": "CORS allowed methods is not set.",
	"-3535": "CORS allowed headers list does not exist.",
	"-3536": "CORS exposed headers list does not exist.",
	"-3537": "Profile not found.",
	"-3538": "Profile rule not found.",
	"-3539": "This profile does not support add exception.",
	...
	"-4198": "The memeber type with NTLM only support Normal Group Type",
	"-4199": "Only allow one NTLM server when client auth. method is NTLM",
	"-4270": "Only HTTP Form is support 2FA authentication",
	"-4399": "Only local and NTLM member is allowed if authentication method is NTLM",
	...
	"-4222": "client ssl versions are not continuous.",
	"-4223": "client backend ssl versions are not continuous.",
	...
	"-4230": "The Verify group is referenced, please dereference it first before you delete its last member",
	"-4231": "Client SSL Supported Groups have no FFDHExxx",
	"-4232": "Client SSL enabled RFC7919 Comply but no DHE ciphers",
	"-4233": "Client SSL Supported Groups have no EC curve",
	"-4234": "Client SSL add EC curve in Supported Groups but no ECDHE ciphers",
	"-4235": "Client SSL RFC7919 Comply can not support TLS 1.3",
	"-4236": "Client SSL RFC7919 Comply can not support SSLv3",
	...
	"-6034": "FTP profile requires security when setting client ssl profile.",
	"-6035": "FTP profile with secutiy doesn't support forward-proxy",
	"-6036": "FTP profile with secutiy doesn't support TLSv1.3",
	"-6037": "There is a conflict between client ssl profile and the profile type, FTP profile with security require local-certificate-group.",
	"-6038": "FTP profile with security doesn't support client-certificate-verify.",
	"-6039": "FTP profile with security doesn't support client-sni-required.",
	"-6040": "FTP profile with security doesn't support reject-ocsp-stapling-with-missing-nextupdate.",
	"-6041": "FTP profile with security doesn't support renegotiation.",
	"-6042": "FTP profile with security doesn't support ssl-dynamic-record-sizing.",
	"-6043": "FTP profile with security should set persistence.",
	"-6044": "FTP profile with security should set client ssl profile.",
	"-6046": "L4 FTP VS doesn't support client ssl profile.",
	"-6048": "L4 FTP VS doesn't support FTP SSL.",
	...
	"-4861": "real sever pool ssl versions are not continuous.",
	"-4862": "client ssl no shared cipher for SSL versoin and cipher suite.",
	"-4863": "backend ssl no shared cipher for SSL versoin and cipher suite.",
	"-4864": "real server ssl no shared cipher for SSL versoin and cipher suite.",
	"-4865": "server ssl no shared cipher for SSL versoin.",
	"-4866": "client ssl no shared cipher for SSL versoin, cipher suite and cert type(RSA|ECDSA).",
	"-4867": "client verify group no member",
	"-4868": "Real Server SSL Supported Groups have no FFDHExxx",
	"-4869": "Real Server SSL enabled RFC7919 Comply but no DHE ciphers",
	"-4870": "Real Server SSL Supported Groups have no EC curve",
	"-4871": "Real Server SSL add EC curve in Supported Groups but no ECDHE ciphers",
	"-4872": "Real Server SSL RFC7919 Comply can not support TLS 1.3",
	"-4873": "Real Server SSL RFC7919 Comply can not support SSLv3",
	...
	"-4910": "No report-uri directive in policy when report-only is enabled",
	"-4911": "No duplicated header name allowed in Add-Replace or Add-If-Absent mode",
	"-4912": "URL regular expression is invalid.",
	...
	"-5010": "Duplicate rule",
	"-5011": "Duplicate user",
	"-5012": "Can't change API Key for the user",
	"-5013": "Can't change UUID for the user",
	"-5030": "The virtual path is conflict with other configure's vpath, please check the related VS's error page, custom auth form base, captcha profile and SAML configure.",
	"-5031": "This virtual server has conflict virtual path, please check error page, custom auth form base, captcha profile and SAML configure.",
	"-5050": "The captcha profile mustn't be NULL, please select a captcha profile.",
	"-5100": "Insufficient FortiToken Cloud service points.",
	"-5101": "Invalid email.",
	"-5102": "Require mobile number.",
	"-5103": "Invalid mobile number.",
	"-5104": "FortiADC connect to cloud server error.",
	"-5105": "Server error.",
	"-5106": "Unknown error.",
	"-5107": "Need token.",
	"-5108": "Invalid token.",
	"-5109": "FTM check timeout",
	"-5110": "Not support ftm push",
	"-5111": "Local user two-factor is enabled. Disable it first",
	"-5200": "The listen port(http, https, ssh or telnet) of the IPv4 interface address is used by other.",
	"-5201": "The listen port(http, https, ssh or telnet) of the IPv6 interface address is used by other.",
	"-5202": "The listen port(http, https, ssh or telnet) of the floating address is used by other.",
	"-5203": "The listen port(http, https, ssh or telnet) of the secondary address is used by other.",
	"-5204": "The listen port(http, https, ssh or telnet) of the secondary floating address is used by other.",
	"-5205": "The listen port(http, https, ssh or telnet) of the HA node address is used by other.",
	"-5206": "The listen port(http, https, ssh or telnet) of the HA node secondary address is used by other.",
	"-5207": "The listen port(http, https, ssh or telnet) of the HA mgmt address is used by other.",
	"-5220": "SNMP listen port of the IPv4 interface address is used by other.",
	"-5221": "SNMP listen port of the IPv6 interface address is used by other.",
	"-5222": "SNMP listen port of the floating address is used by other.",
	"-5223": "SNMP listen port of the secondary address is used by other.",
	"-5224": "SNMP listen port of the secondary floating address is used by other.",
	"-5225": "SNMP listen port of the HA node address is used by other.",
	"-5226": "SNMP listen port of the HA node secondary address is used by other.",
	"-5227": "SNMP listen port of the HA mgmt address is used by other.",
	"-5230": "Explicit HTTP VS must a L7 type VS.",
	"-5240": "The direct route ip of pool is not consistent with related virtual server ip",
	"-5241": "The health check type is not supported in direct-route mode.",
	"-5242": "The direct-route pool is referenced by a non direct-route virtual server.",
	"-5300": "oauth redirect url must start with '/'",
	"-5301": "oauth logout url must start with '/'",
	"-5302": "oauth path can't be '/'",
	"-5303": "oauth auth url must start with 'https://'",
	"-5304": "oauth token url must start with 'https://'",
	"-5305": "auth path conflict with oauth redirect url",
	"-5331": "Must configure password when username is set.",
	"-5332": "Must configure username when password is set.",
	"-5333": "Can't change status. The external resource is in use.",
	"-5999": "SSLi re-encryption ssl profile used by L2/L3 should not set SNI",
	"-6000": "SSLi decryption real server ssl should disable",
	"-6001": "SSLi re-encryption real server ssl should enable",
	"-6002": "SSLi decryption real server pool member is more than 1",
	"-6003": "SSLi re-encryption real server pool member is more than 1",
	"-6004": "SSLi instance only support at most 8 port ranges.",
	"-6005": "SSLi instance port should be a number or a range with '-'.",
	"-6006": "SSLi instance port should be 0 or 1-65535, and port start should be no larger than port end.",
	"-6007": "The specified decryption ip|port is already used by another SSLi instance decryption.",
	"-6008": "The specified decryption ip|port is already used by another SSLi instance re-encryption.",
	"-6009": "The specified re-encryption ip|port is already used by another SSLi instance decryption.",
	"-6010": "The specified re-encryption ip|port is already used by another SSLi instance re-encryption.",
	"-6011": "L2 bind interface conflict.",
	"-6012": "SSLi mode already enabled",
	"-6013": "SSLi mode enable failed",
	"-6014": "SSLi mode already disabled",
	"-6015": "SSLi mode disable failed",
	"-6016": "SSLi inbound interface is not soft switch for L2 topology",
	"-6017": "SSLi outbound interface is not the member of decryption soft-switch",
	"-6018": "SSLi L7 should not enable forward proxy",
	"-6019": "The specified decryption and re-encryption ip|port is conflict.",
	"-6020": "The decryption pool of L2/L3 SSLi instance can't support ipv6.",
	"-6021": "The encryption pool of L2/L3 SSLi instance can't support ipv6.",
	"-6022": "The addr type of decryption pool and of SSLi instance are not match.",
	"-6023": "The addr type of encryption pool and of SSLi instance are not match.",
	"-6024": "The alert and policy type are not match.",
	"-6025": "policy  only need one alert member.",
	"-6026": "alert member has duplicated events.",
	"-6027": "alert policy has not alert member.",
	"-6028": "Input a domain name without a '.' at the beginning.",
	"-6029": "Vdom-link entry can't be deleted, move the interface to root vdom firstly.",
	"-6030": "The device memory is too low to support RAM disk.",
	"-6031": "Ramdisk size has been changed, the specified space will be occupied by anti-virus scanning, please reboot the device to take effect.",
	"-6032": "It is enabled.",
	"-6033": "Disable private key encription first.",
	"-6045": "The NF SNAT range is conflict with VS ippool.",
	"-6047": "The alert and policy filter scope are not match.",
	"-6049": "Once SameSite is set to None, Secure attribute must also be enabled.",
	"-6050": "The custom attribute value does not seem to be formatted correctly.",
	"-6051": "The hash cookie keyword shall be a valid cookie name.",
	"-6052": "The custom attribute value is missing while the option is enabled.",
	"-6053": "The cookie domain does not seem to be formatted correctly.",
	"-6054": "The license is a trial license.",
	"-6055": "The FortiADC license does not support EMS related feature.",
	"-6056": "Invalid IP address or vs name filter for the WAF blocked IP.",
	"-6057": "Failed to release WAF blocked IP with provided contitions.",
	"-6070": "Only port1 is allowed in current design",
	"-6071": "FortiADC is not in any cloud autoscaling group",
	"-6072": "Life cycle state of FortiADC is not InService",
	"-6073": "HA is enabled. Please disable it first.",
	"-6074": "Auto-scale is enabled or the FAD is currently in ASG. Please disable auto-scale or detach the FAD from ASG.",
}
