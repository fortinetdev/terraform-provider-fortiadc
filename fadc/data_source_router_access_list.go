...
func dataSourceFlattenRouterAccessListDescription(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}

func dataSourceFlattenRouterAccessListMkey(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}
...
func dataSourceRefreshObjectRouterAccessList(d *schema.ResourceData, o map[string]interface{}) error {
	...
	if err = d.Set("description", dataSourceFlattenRouterAccessListDescription(o["description"], d, "description")); err != nil {
		if !fortiAPIPatch(o["description"]) {
			return fmt.Errorf("Error reading description: %v", err)
		}
	}

	if err = d.Set("mkey", dataSourceFlattenRouterAccessListMkey(o["mkey"], d, "mkey")); err != nil {
