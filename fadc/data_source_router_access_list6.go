...
func dataSourceFlattenRouterAccessList6Description(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}

func dataSourceFlattenRouterAccessList6Mkey(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}
...
func dataSourceRefreshObjectRouterAccessList6(d *schema.ResourceData, o map[string]interface{}) error {
	...
	if err = d.Set("description", dataSourceFlattenRouterAccessList6Description(o["description"], d, "description")); err != nil {
		if !fortiAPIPatch(o["description"]) {
			return fmt.Errorf("Error reading description: %v", err)
		}
	}

	if err = d.Set("mkey", dataSourceFlattenRouterAccessList6Mkey(o["mkey"], d, "mkey")); err != nil {
