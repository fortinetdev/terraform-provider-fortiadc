...
func dataSourceFlattenRouterPrefixListDescription(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}

func dataSourceFlattenRouterPrefixListMkey(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}
...
func dataSourceRefreshObjectRouterPrefixList(d *schema.ResourceData, o map[string]interface{}) error {
	...
	if err = d.Set("description", dataSourceFlattenRouterPrefixListDescription(o["description"], d, "description")); err != nil {
		if !fortiAPIPatch(o["description"]) {
			return fmt.Errorf("Error reading description: %v", err)
		}
	}

	if err = d.Set("mkey", dataSourceFlattenRouterPrefixListMkey(o["mkey"], d, "mkey")); err != nil {
