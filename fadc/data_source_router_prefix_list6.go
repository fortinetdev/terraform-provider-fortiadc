...
func dataSourceFlattenRouterPrefixList6Description(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}

func dataSourceFlattenRouterPrefixList6Mkey(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}
...
func dataSourceRefreshObjectRouterPrefixList6(d *schema.ResourceData, o map[string]interface{}) error {
	...
	if err = d.Set("description", dataSourceFlattenRouterPrefixList6Description(o["description"], d, "description")); err != nil {
		if !fortiAPIPatch(o["description"]) {
			return fmt.Errorf("Error reading description: %v", err)
		}
	}

	if err = d.Set("mkey", dataSourceFlattenRouterPrefixList6Mkey(o["mkey"], d, "mkey")); err != nil {
