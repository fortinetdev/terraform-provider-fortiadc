...
// Description: Configure  router prefix list.
...
func resourceRouterPrefixListCreate(d *schema.ResourceData, m interface{}) error {
	...
	_, err = c.CreateRouterPrefixList(obj, vdom)
	if err != nil {
...
func resourceRouterPrefixListUpdate(d *schema.ResourceData, m interface{}) error {
	...
	_, err = c.UpdateRouterPrefixList(obj, mkey, vdom)
	if err != nil {
...
func resourceRouterPrefixListDelete(d *schema.ResourceData, m interface{}) error {
	...
	err := c.DeleteRouterPrefixList(mkey, vdom)
	if err != nil {
...
func resourceRouterPrefixListRead(d *schema.ResourceData, m interface{}) error {
	...
	o, err := c.ReadRouterPrefixList(mkey, vdom)
	if err != nil {
...
func flattenRouterPrefixListDescription(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}

func flattenRouterPrefixListMkey(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}
...
func refreshObjectRouterPrefixList(d *schema.ResourceData, o map[string]interface{}, sv string) error {
	...
	if err = d.Set("description", flattenRouterPrefixListDescription(o["description"], d, "description", sv)); err != nil {
		if !fortiAPIPatch(o["description"]) {
			return fmt.Errorf("Error reading description: %v", err)
		}
	}

	if err = d.Set("mkey", flattenRouterPrefixListMkey(o["mkey"], d, "mkey", sv)); err != nil {
...
func expandRouterPrefixListDescription(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}

func expandRouterPrefixListMkey(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}
...
func getObjectRouterPrefixList(d *schema.ResourceData, sv string) (*map[string]interface{}, error) {
	...
	if v, ok := d.GetOk("description"); ok {
		t, err := expandRouterPrefixListDescription(d, v, "description", sv)
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["description"] = t
	...
	if v, ok := d.GetOk("mkey"); ok {
		t, err := expandRouterPrefixListMkey(d, v, "mkey", sv)
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["mkey"] = t
